const BrandCardLg = () => {
  return (
    <div className="row big-card mx-0 px-0">
      <div className="row mx-0 px-0">
        <div className="fs-10 fst-italic text-primary text-end px-0 px-2 py-2">T&C</div>
        <div className="row mx-0 px-0 text-center d-flex justify-content-center align-item-center d-md-block d-none">
          <div className="col-12">
            <img src="/shoes.jpeg" className="big-card--upperlogo" />
          </div>
        </div>
        <div className="row mx-0 px-0 text-center d-flex justify-content-center align-item-center ">
          <div className="col-12">
            <img src="/bata-logo.png" className="w-100 big-card--lowerlogo" />
          </div>
        </div>
      </div>
      <div className="row mx-0 px-0">
        ...
        <div className="col-6 d-flex justify-content-end">
          <div>
            <img src="/how-to-use.png" className="w-100" />
          </div>
        </div>
      </div>
